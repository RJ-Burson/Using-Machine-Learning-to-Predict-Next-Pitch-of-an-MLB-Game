...
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="Joe Mantiply")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="Joe Mantiply")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="Joe Mantiply")[,-c(1,3)]
...
BalancedData3 = ovun.sample(pitch_name~. , si_cu, method="over", p=0.75, subset=options("subset")$subset,
                            na.action=options("na.action")$na.action, seed)$data
