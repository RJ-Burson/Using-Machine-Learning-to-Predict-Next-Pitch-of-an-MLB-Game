...
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="Aroldis Chapman")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="Aroldis Chapman")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="Aroldis Chapman")[,-c(1,3)]
...
BalancedData1 = ovun.sample(pitch_name~. , ff_si, method="over", p=0.75, subset=options("subset")$subset,
