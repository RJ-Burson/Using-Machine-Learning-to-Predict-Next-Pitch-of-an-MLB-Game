...
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="Buck Farmer")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="Buck Farmer")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="Buck Farmer")[,-c(1,3)]
