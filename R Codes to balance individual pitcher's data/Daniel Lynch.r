...
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="Daniel Lynch")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="Daniel Lynch")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="Daniel Lynch")[,-c(1,3)]
