...
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="Reynaldo Lopez")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="Reynaldo Lopez")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="Reynaldo Lopez")[,-c(1,3)]
