...
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="Robert Stephenson")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="Robert Stephenson")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="Robert Stephenson")[,-c(1,3)]
...
BalancedData1 = ovun.sample(pitch_name~. , ff_cu, method="over", p=0.75, subset=options("subset")$subset, 
