...
##### David Peterson
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="David Peterson")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="David Peterson")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="David Peterson")[,-c(1,3)]
