...
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="Brett Martin")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="Brett Martin")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="Brett Martin")[,-c(1,3)]
...
BalancedData2 = ovun.sample(pitch_name~. , si_cu, method="over", p=0.75, subset=options("subset")$subset,
                            na.action=options("na.action")$na.action, seed)$data
