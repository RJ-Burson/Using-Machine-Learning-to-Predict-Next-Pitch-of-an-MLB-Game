...
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="Tyler Rogers")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="Tyler Rogers")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="Tyler Rogers")[,-c(1,3)]
...
BalancedData1 = ovun.sample(pitch_name~. , si_ff, method="over", p=0.66, subset=options("subset")$subset, 
