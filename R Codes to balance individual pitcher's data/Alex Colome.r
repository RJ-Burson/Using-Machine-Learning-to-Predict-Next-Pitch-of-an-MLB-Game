...
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="Alex Colome")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="Alex Colome")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="Alex Colome")[,-c(1,3)]


ff_cut= subset(train_set, pitch_name==1 | pitch_name==4)


BalancedData1 = ovun.sample(pitch_name~. , ff_cut, method="over", p=0.5, subset=options("subset")$subset,
