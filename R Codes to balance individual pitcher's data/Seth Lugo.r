...
train_set= subset(dfvnew_train, dfvnew_train$pitcher=="Seth Lugo")[,-c(1,3)]
validation_set= subset(dfvnew_valid, dfvnew_valid$pitcher=="Seth Lugo")[,-c(1,3)]
final_test= subset(dfvnew_test, dfvnew_test$pitcher=="Seth Lugo")[,-c(1,3)]
